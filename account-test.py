...
class TestAccount(unittest.TestCase):
    def setUp(self):
        self.new_account = Account("Subira","Facebook","232323","clin@g.com") #created account object

    def test_init(self):
        """
        test_init is to test if the objects are initialized properly
        """ 
        self.assertEqual(self.new_account.user_name,"Subira")
    ...
    def test_save_multiple_account(self):
        ...
        """
        self.new_account.save_account()
        test_account =Account("Sue","twiter","565656","tw@g.com")
    ...
    def test_find_account_by_account_name(self):
        ...
        found_account = Account.find_by_name("twiter")
    ...
    def test_account_exists(self):
        ...
        self.new_account.save_account()
        test_account = Account("Sue","twiter","565656","tw@g.com") # new account
        test_account.save_account()
